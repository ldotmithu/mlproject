...
from mlProject.components.data_trnsfomation import DataTransformationConfig,DataTransformation
...
if __name__=="__main__":
    ...
    data_transform.initiate_get_data_transform(train_path=train_data,test_path=test_data)
