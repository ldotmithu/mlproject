...
from mlProject.components.data_trnsfomation import DataTranfomation
...
if __name__=="__main__":
    obj=DataIngestion()
    traib_data,test_data=obj.initiate_data_ingestion()   
    
    data_transform=DataTranfomation()
    data_transform.initiate_get_data_transform(train_path=traib_data,test_path=test_data)
